...
check_kernel(){
	...
	already_image=`rpm -qa | grep kernel-4.13.9`
	already_devel=`rpm -qa | grep kernel-devel-4.13.9`
	already_headers=`rpm -qa | grep kernel-headers-4.13.9`

	# surplus kernel count
	#surplus_image=`rpm -qa | grep kernel | awk '{print $2}' | grep -v "4.13.9" | wc -l`
	#surplus_devel=`rpm -qa | grep kernel-devel | awk '{print $2}' | grep -v "4.13.9" | wc -l`
	#surplus_headers=`rpm -qa | grep kernel-headers | awk '{print $2}' | grep -v "4.13.9" | wc -l`

	# surplus kernel sort
	surplus_count=`rpm -qa | grep kernel | grep -v "4.13.9" | wc -l`
...
delete_surplus(){
		...
		do
			 surplus_sort=`rpm -qa | grep kernel | grep -v "4.13.9"`
